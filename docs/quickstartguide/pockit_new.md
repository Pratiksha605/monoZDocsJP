...
　  　認証が不要な場合は「No Authorization」を選択します。\
  ...
  ⑦　[保存]をクリックします。
    <img className="img-center" src={require('@site/static/img/quickguide5_1.png').default} /><br/>
...
初めて作成したグループは自動的に「デフォルト」グループとして割り当てられます。\
  ...
  ④ [保存]をクリックします。
   ...
   <img className="img-center" src={require('@site/static/img/quickguide6_1.png').default} /><br/>
...
必要に応じてデバイスを別のグループに移動させてください。このステップで、monoZ:Link のセットアップは完了です。
    <img className="img-center" src={require('@site/static/img/quickguide7_1.png').default} /><br/>
    <img className="img-center" src={require('@site/static/img/quickguide7_2.png').default} /><br/>
